...
PARELLES = [
    ...
    ('"text": "des dels 3 anys, amb la iniciació a la dansa, i sense límit d\'edat per dalt: tenim grups infantils, juvenils i d\'adults, sempre organitzats per edats i nivells. de 0 a 99!"',
     '"text": "desde los 3 años, con la iniciación a la danza, y sin límite de edad por arriba: tenemos grupos infantiles, juveniles y de adultos, siempre organizados por edades y niveles. ¡de 0 a 99!"'),
    ...
    ("des dels 3 anys, amb la iniciació a la dansa, i sense límit d'edat per dalt: tenim grups infantils, juvenils i d'adults, sempre organitzats per edats i nivells. de 0 a 99!",
     'desde los 3 años, con la iniciación a la danza, y sin límite de edad por arriba: tenemos grupos infantiles, juveniles y de adultos, siempre organizados por edades y niveles. ¡de 0 a 99!'),
...
from blog_posts import POSTS as _POSTS, entradeta_min as _em  # noqa: E402
...
for _p in sorted(_POSTS, key=lambda x: x["data"], reverse=True)[:3]:
    for _pa in [
        ...
        (f'<p>{_e(_em(_p["excerpt"]))}</p>', f'<p>{_e(_em(_p["excerpt_es"]))}</p>'),
