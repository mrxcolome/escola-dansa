# Ballar en família: quan mares i filles comparteixen escola

*27 de maig de 2026 · 4 min*

Una de les escenes que més ens agraden: la nena entra a la seva classe, i la mare — en lloc de fer temps en un banc — entra a la seva. Mateixa hora, mateixa escola, cadascuna al seu món.

Fa anys, la imatge típica de la porta de l'escola era una filera de mares i pares esperant amb el mòbil a la mà. Cada cop més, aquella espera s'ha convertit en una altra cosa: **la seva pròpia classe**. Mentre la petita fa clàssic infantil, la mare fa [barre o ioga](/cos-benestar/); mentre l'adolescent sua al hip-hop, el pare descobreix que el claqué era el seu ball secret.

## La logística que es resol sola

El primer avantatge és pràctic i és enorme: **un sol viatge, dues activitats**. La conciliació és el gran enemic de l'exercici dels adults — «no tinc temps» quasi sempre vol dir «no tinc una hora que quadri». Si la teva hora quadra exactament amb la de la teva filla, l'excusa s'evapora. Mireu junts la [graella](/horaris/): hi ha més coincidències de les que us penseu.

## El vincle que es crea

Hi ha alguna cosa especial a compartir el camí de l'escola: sortir de casa amb les bosses de dansa, comentar la classe de tornada, entendre de què parla l'altra quan diu que avui «li ha sortit el gir». No cal ballar juntes ni fer el mateix estil — de fet, gairebé millor que no: **cadascuna té el seu espai**, i el que es comparteix és la passió, no la sala.

## L'exemple silenciós

I hi ha un efecte més profund que veiem sovint: quan una nena veu que la seva mare també va a classe, també s'equivoca, també repeteix i també progressa, el missatge que rep no és cap sermó — és un exemple. L'esforç, la constància i el gust per aprendre **es transmeten millor ballant que dient-los**.
